...
func TestProductionRouterWiringAndMutationSecurity(t *testing.T) {
	...
	requiredD5Routes := []struct {
		...
		{method: "PATCH", path: "/api/v1/courses/:id/revisions/:revisionId/sections/order"},
		...
		{method: "PATCH", path: "/api/v1/courses/:id/revisions/:revisionId/sections/:sectionId/lessons/order"},
