...
func mountCatalogRoutes(
	...
	)
	{
		...
		ownedMutationGroup.PATCH("/revisions/:revisionId/sections/order", h.reorderSections)
		...
		ownedMutationGroup.PATCH("/revisions/:revisionId/sections/:sectionId/lessons/order", h.reorderLessons)
