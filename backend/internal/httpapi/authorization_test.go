...
const lessonVideoUploadCompletionPath = "/api/v1/courses/:id/revisions/:revisionId/lessons/:lessonId/video/upload-completions"
...
var expectedRouteMatrix = map[string]RouteMatrixEntry{
	...
	"PATCH /api/v1/courses/:id/revisions/:revisionId/sections/order":                    {Method: http.MethodPatch, Path: "/api/v1/courses/:id/revisions/:revisionId/sections/order", Class: ClassOwnershipProtected},
	...
	"PATCH /api/v1/courses/:id/revisions/:revisionId/sections/:sectionId/lessons/order": {Method: http.MethodPatch, Path: "/api/v1/courses/:id/revisions/:revisionId/sections/:sectionId/lessons/order", Class: ClassOwnershipProtected},
	...
	"GET /api/v1/admin/review/playback-manifests/:playbackSession/renditions/:rendition/index.m3u8": {Method: http.MethodGet, Path: "/api/v1/admin/review/playback-manifests/:playbackSession/renditions/:rendition/index.m3u8", Class: ClassCapabilityProtected},
