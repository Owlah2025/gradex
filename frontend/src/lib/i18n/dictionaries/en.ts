export const en = {
  ...
  adminBundles: {
    ...
    intro: "Create and manage multi-Course catalogue offers. Payment confirmation grants the saved Course snapshot atomically.",
    draftHint: "Drafts can be saved while you are still adding Courses, descriptions, or pricing.",
    ...
    search: "Search published Courses",
    selected: "Selected Courses",
    regularPrice: "Regular price (fils)",
    offerPrice: "Offer price (optional, fils)",
    reason: "Pricing change reason",
    save: "Save draft",
    update: "Save changes",
    publish: "Publish",
    delist: "Hide",
    ...
    empty: "No Bundles yet. Create the first Bundle from published Courses.",
    failed: "Bundles could not be loaded.",
    saved: "Bundle saved.",
    coursesLoading: "Loading eligible Courses…",
    coursesFailed: "Eligible Courses could not be loaded.",
    retryCourses: "Try again",
    noCourses: "No eligible Courses match this search.",
    previousCourses: "Previous Courses",
    nextCourses: "Next Courses",
    coursePage: "Course page {page}",
    minimum: "Select at least two distinct published Courses before publishing.",
    invalidOffer: "Offer price must be positive and lower than regular price.",
    pricingTitle: "Course offer pricing",
    pricingIntro: "Set or clear the public offer without editing Course content.",
    selectCourse: "Select a published Course",
    clearOffer: "Clear offer",
    savePricing: "Save Course pricing",
  },
  adminReview: {
    ...
    inspector: {
      ...
      coursePreviewHeading: "Public course preview",
      coursePreviewWatch: "Play the submitted course preview",
      coursePreviewLoading: "Preparing the preview…",
      coursePreviewFailed: "The submitted course preview could not be played.",
      coursePreviewMismatch:
        "The issued course preview did not match the submitted revision.",
  ...
  bundles: {
    title: "Course Bundles",
    subtitle: "Several published Courses under one Bundle price.",
    loading: "Loading Course Bundles…",
    failed: "Course Bundles could not be loaded. Try again.",
    emptyTitle: "No Course Bundles yet",
    emptyBody: "Published Bundles will appear here when they are available.",
    detailBack: "Back to the catalogue",
    included: "Courses in this Bundle",
    paymentTitle: "Request this Bundle",
    paymentBody: "Payment is completed outside Gradex. After an Admin confirms it, access to every included Course is granted together.",
    request: "Request Bundle purchase",
    pending: "Your Bundle purchase request is waiting for payment confirmation.",
    granted: "Bundle access granted. The included Courses are now in your learning dashboard.",
    historyLoading: "Checking your purchase history…",
    historyFailed: "Your purchase history could not be checked, so a duplicate request is blocked.",
    retryHistory: "Check again",
  ...
  learning: {
    ...
    learningTabs: "About this lesson",
    overview: "Overview",
