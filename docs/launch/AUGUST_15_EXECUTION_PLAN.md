...
| S11 | End-to-end critical-journey tests across the full path, error states and recovery paths | A | S1C–S6 | 8h | **2** | Yes |
...
| S10 | Bilingual Privacy Notice, Terms, Refund Policy, course-access disclosures, support route | A (LG-011) | Revenue reporting screens, payout records, emailed Instructor statements | **C** | 5h | 2 |
