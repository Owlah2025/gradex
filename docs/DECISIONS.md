...
**Date:** 2026-09-10
**Status:** Independently approved at `8ee8d42215fd1f5671499a2e370e909ca9a4aea2`.
...
**Database:** One additive migration, `0037_student_trusted_devices`, applied after
`0036_bundles_and_offers`. The two features create no product dependency; the migration renumber is
an integration-only change and must be reverified in the combined release candidate.
