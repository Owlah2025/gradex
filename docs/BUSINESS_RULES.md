...
- **BR-135** — Student discovery/join requires runtime Course access, no emergency access suspension, and an active Course Entitlement or Section Entitlement within that Course. Delisting/retirement/archival alone does not hide an existing entitled Student's scheduled Session; cancellation or access suspension does. Admins may access for moderation. *(D-013/D-029)*
...
- **BR-146** — A report never hides content automatically. An Admin may dismiss it, request changes, delist future discovery/checkout, retire future acquisition/inclusion, invoke constrained emergency Course access suspension, or suspend an Account. Resolution records actor, reason, exact action, and timestamp; relevant Instructor/Student notices follow the fixed transactional policy. *(D-019/D-029; BR-120/122)*
